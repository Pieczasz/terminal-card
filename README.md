...
```bash
# prerequisites: Go 1.27+, PostgreSQL, golangci-lint (optional)
...
| Doc | Role |
|---|---|
| [`READING_GUIDE.md`](READING_GUIDE.md) | File-by-file / module tour + data flows + tooling (GitNexus, …) |
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | Contracts, topology, invariants |
| [`ONBOARDING.md`](ONBOARDING.md) | Product context and patterns |
| [`CLAUDE.md`](CLAUDE.md) | Short operational brief |
